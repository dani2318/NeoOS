...
toolchainDir = Path(HOST_ENVIRONMENT['toolchain'], platform_prefix.removeprefix('-'))
toolchainBin = Path(toolchainDir, 'bin')
toolchainGCCLibs = Path(toolchainDir, 'lib','gcc', platform_prefix.removeprefix('-'), DEPS['gcc'])
