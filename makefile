...
.PHONY: all floppy_image hdd_image kernel bootloader clean always run libcore
...
stage2: $(BUILD_DIR)/stage2.bin libcore

$(BUILD_DIR)/stage2.bin: always
	$(MAKE) -C $(SRC_DIR)/boot/stage2 BUILD_DIR=$(abspath $(BUILD_DIR))

libcore:
	$(MAKE) -C $(SRC_DIR)/libs/core BUILD_DIR=$(abspath $(BUILD_DIR))

#
#	kernel
#

kernel: $(BUILD_DIR)/kernel.bin libcore
